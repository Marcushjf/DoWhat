...
function Body({ login }: BodyProps) {
  return (
    <div className="p-0">
      <nav
        className="navbar bg-body-tertiary p-0 m-0 fixed-top"
        style={{ height: "100px" }}
      >
    ...
    <div className="row d-flex m-0 p-0 pt-5 pb-5 bg-body justify-content-center">
      <div className="col-lg-4 p-5 d-flex justify-content-end">
        <div className="" style={{ maxWidth: "560px" }}>
          ...
          <h4 className="p-3 pt-3 pb-5">
            So many tasks, so little time — made easier for effective
            communication
          </h4>
          <div className="p-2">
            <Reveal>
...
function SecondSection() {
  return (
    <div className="row d-flex justify-content-center p-0 m-0 pt-5 pb-5">
      ...
      >
        <div
          className="d-flex flex-column justify-content-center col-md-4 row-md-4 p-5"
          style={{ minWidth: "460px", width: "600px" }}
        >
          <Reveal>
          ...
          <Reveal>
            <h4>
              Never lose sight of your goals again and Track your progress
              effortlessly as you check off tasks.
            </h4>
          </Reveal>
        </div>
        <div
          className="d-flex flex-column justify-content-center col-md-4 row-md-4 p-5"
          style={{ height: "460px", minWidth: "460px", width: "600px" }}
        >
          <ScrollFade>
            <img
              src="/Screenshot1.png"
      ...
      >
        ...
        >
          ...
          <Reveal>
            <h4>
              Organize tasks systematically, making it easier to prioritize and
              manage workload.
            </h4>
          </Reveal>
        </div>
      ...
      >
        ...
        >
          ...
          <Reveal>
            <h4>
              Stay focused on your objectives while maintaining seamless
              communication.
            </h4>
          </Reveal>
        </div>
